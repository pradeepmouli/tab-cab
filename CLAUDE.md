...
- **Entitlements File**: `Config/SwiftTemplateiOS.entitlements` contains all app capabilities
...
To add capabilities to your app, edit `Config/SwiftTemplateiOS.entitlements`:
...
// In your app
@main
struct SwiftTemplateiOSApp: App {
    var body: some Scene {
        WindowGroup {
            ContentView()
