...
struct TabAssociationServiceTests {
    ...
    func testCreateGroupSavesToRepository() async throws {
        ...
        let service = TabAssociationService(repository: repository, tabManager: tabManager)
    ...
    func testGetAllGroupsReturnsSortedByCreationDate() async throws {
        ...
        let all = try await service.getAllAssociations()
    ...
    func testGetUngroupedTabsFiltersOutGroupedTabs() async throws {
        ...
        tabManager.stubbedTabs = [
            TabInfo(id: "tab-1", url: URL(string: "https://example.com")!, title: "Tab 1", windowID: "window-1", index: 0, isActive: false, isPinned: false),
            TabInfo(id: "tab-2", url: URL(string: "https://example.com")!, title: "Tab 2", windowID: "window-1", index: 1, isActive: false, isPinned: false),
            TabInfo(id: "tab-3", url: URL(string: "https://example.com")!, title: "Tab 3", windowID: "window-1", index: 2, isActive: false, isPinned: false)
        ]
